...
| 項目 | 說明 |
|:---|:---|
| 五語系 | 中／英／日／韓／阿拉伯文即時切換，自動偵測瀏覽器語言；也可用 `?lang=ja` 指定。阿拉伯文為由右至左排版，版面自動鏡射 |
| 五項服務 | 量子整骨、體雕塑身、整椎正骨、按摩推拿、醫美整骨 |
| 兩種時長 | 40 分鐘 NT$1,688；60 分鐘 NT$2,888 |
| 醫美整骨 | 改為選部位計價：擇三 NT$1,688、擇五 NT$2,888、十項全選 NT$4,588（90 分鐘，另含四項加贈），選滿才能進下一步 |
| 七天前置 | 日曆自動鎖住今天起七天內的日期，只開放七天後至四個月內（`leadDays`） |
| 營業時間 | 週一至週六 09:00–21:00；週四只到 17:00；週日 09:00–12:00；每日 12:00–14:00 休息 |
...
slotStep: 30,                         // 時段間隔（分鐘）
breaks: [['12:00', '14:00']],         // 每日休息時間，療程跨進去的時段會被擋掉
