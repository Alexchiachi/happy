...
2. 挑照片：資料夾裡檔名有「封面」的當商品卡封面，沒有就挑構圖最適合直式 4:5 的那張。
   - 廣告圖上燒了價格、規格條列、行銷標語的，只裁出照片區域。
     商品包裝、品牌標誌上本來就有的字（含簡體字）照常保留——雲南好物的產品介紹與包裝本來就是簡體。
   - AI 生成的圖**可以用**（使用者 2026-09-26 決定）。角落的 Gemini 浮水印（右下角四角星）在裁 4:5 時裁掉；
     裁不掉時先問使用者。例：藏香現用 05／IMG_6773（雪山、經幡），浮水印在最底部，裁切時已排除。
   - 同批的紅糖三味用 IMG_8034（廣告圖，只裁中段三盒照片，不帶上方規格文字與下方價格）。
   - 2026-09-26 下午 Rena 補齊各資料夾照片後，網站上 16 樣商品都有照片（02 普洱改用 IMG_3488 白底禮袋照，
     03 湯包換成 IMG_3063 高解析版，04、06、11、12、15、18、21、22 從各自資料夾挑一張裁切）。
     廣告圖一律只裁照片區域；普洱是大卡（`featured`），電腦版圖片會被裁成瘦長比例，只看得到中段。
     19 雲南白藥牙膏、20 雲南天然線香資料夾也有照片，但資料表還沒有規格價格，網站沒有這兩樣，先不處理。
   - 00 共用的「云南礼物 YUNNAN LIWU」標誌（IMG_7493 紅底插畫版、IMG_7494 白底字標）：使用者同意之後可以用
     （簡體字沒關係），目前還沒決定放哪裡，放之前先跟使用者確認位置。
